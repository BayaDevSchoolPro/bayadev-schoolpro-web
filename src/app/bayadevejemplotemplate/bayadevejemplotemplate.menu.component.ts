...
@Component({
    selector: 'bayadevejemplotemplate-menu',
    templateUrl: './bayadevejemplotemplate.menu.component.html'
})
export class BayadevejemplotemplateMenuComponent implements OnInit {
